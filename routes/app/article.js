...
router.get('/Obtain/Home', function(req, res, next) {
    var params = req.query;
    var session = req.session;
    ...
    articleService
        .obtainAriticleFromAttentionsAndCorners(session.userGuid, params.articleUserGuid, params.articleGuid, params.direction)
        .then(checkResult)
        .error(checkErr);
